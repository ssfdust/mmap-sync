    ...
    WL: WriteLockStrategy<'a>,
{
        ...
        T: for<'b> Serialize<HighSerializer<AlignedVec, ArenaHandle<'b>, RkyvErr>>,
    {
        ...
        let data = to_bytes_with_alloc::<_, RkyvErr>(entity, arena.acquire()).map_err(|_|  SynchronizerError::FailedEntityWrite)?;
